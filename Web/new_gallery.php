<?php
	...
	move_uploaded_file($_FILES["GalleryimgToUpload"]["tmp_name"], "images/galleries/".$new_filename);
	...
	for ($i = 0; $i<count($_FILES['Imagini']['name']); $i++){
		...
		move_uploaded_file($_FILES['Imagini']['tmp_name'][$i],"images/pictures/".$new_filenames[$i]);
